...
var G__1582 = cljs.core.first.call(null,element_str);
switch (G__1582) {
case "?":
arr.push((1));
...
var G__1584 = cljs.core.next.call(null,items);
items = G__1584;
continue;
} else {
return null;
...
var G__1585 = cljs.core.next.call(null,items);
items = G__1585;
continue;
} else {
return null;
...
var G__1587 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__1587;
continue;
} else {
return true;
...
switch (G__1590) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__1590){
return (function (p1__1588_SHARP_){
return cljs.core.not_EQ_.call(null,p1__1588_SHARP_,(2));
});})(G__1590))
))){
...
return cljs.core.not_EQ_.call(null,p1__1589_SHARP_,(1));
});})(G__1590))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1590)].join('')));
