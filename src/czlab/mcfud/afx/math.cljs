...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn- array-eq?
  "If these 2 arrays are equal."
  [a1 a2]
  (loop [i 0 SZ (n# a1) diff? false]
    (cond (zero? SZ)
          true
          (or (>= i SZ) diff?)
          (not diff?)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn vec-neq?
  "If arrays not equal." [v1 v2] (not (vec-eq? v1 v2)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn vec-lensq
  "Length of vector, squared." [v] (vec-dot v v))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn vec-len
  "Length of vector." [v] (c/sqrt* (vec-dot v v)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn vec-neg
  "Negate a vector," [v] (vec-scale v -1))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn mat-neq?
  "If matrices are different." [a b] (not (mat-eq? a b)))
    ...
    (loop [i 0 SZ cols tmp (c/tvec*)]
      (if (>= i SZ)
        ...
        (recur (+ 1 i)
               SZ
               (loop [[c & cs] css t tmp]
                 (if (nil? c) t (recur cs (conj! t (nth c i))))))))))
...
(defn mat3-fast-inverse
  "Inverse a 3x3 matrix - fast." [m] (mat-xpose m))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defmulti mat-det "Matrix determinent." (fn [m] (:dim m)))
                 ...
                 (if (>= j CZ)
                   ...
                   (recur (+ 1 j)
                          ...
                          (if-not (or (= i row')
                                      (= j col'))
                            (conj! tmp'
                                   (aget arr (+ j (* i cols)))) tmp')))))))))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defmulti mat-minor "Matrix minor." (fn [m] (:dim m)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defmulti mat-inverse "Inverse of matrix." (fn [m] (:dim m)))
...
(defn mat-from-colmajor
  "Matrix from column major." [m] (mat-xpose m))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn mat-to-colmajor
  "Matrix to column major." [m] (mat-xpose m))
...
(defmulti get-translation
  "Get the translation of a matrix." (fn [m] (:dim m)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defmulti mat-fromVX
  "Matrix from vector-translation." (fn [v] (n# v)))
...
(defmulti mat-orthogonal
  "Orthogonal of matrix." (fn [m] (:dim m)))
...
(defmulti mat3-multVX
  "Multiply vector and 3x3 matrix." (fn [v m] (:dim m)))
...
(defmulti mat-decompose
  "Decompose this matrix." (fn [m] (:dim m)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn pythag-sq
  "Hypotenuse squared." [x y] (+ (* x x) (* y y)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn pythag
  "Hypotenuse." [x y] (c/sqrt* (pythag-sq x y)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn wrap??
  "Modulo of the next increment." [i len] (mod (+ 1 i) len))
